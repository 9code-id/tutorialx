...
router.push(OtherView());
router.replaceAll([OtherView()]);
...
class _OtherViewState extends State<OtherView> {
  final controller = sl<OtherController>();
  OtherState get state => controller.state;

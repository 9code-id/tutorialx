...
router.push(CedaokRoute());
router.replaceAll([CedaokRoute()]);
...
@RoutePage()
class CedaokView extends StatefulWidget {
  const CedaokView({super.key});

  @override
  State<CedaokView> createState() => _CedaokViewState();
}

class _CedaokViewState extends State<CedaokView> {
  final controller = sl<CedaokController>();
  CedaokState get state => controller.state;

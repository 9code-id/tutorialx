...
router.push(SodakoRoute());
router.replaceAll([SodakoRoute()]);
...
@RoutePage()
class SodakoView extends StatefulWidget {
  const SodakoView({super.key});

  @override
  State<SodakoView> createState() => _SodakoViewState();
}

class _SodakoViewState extends State<SodakoView> {
  final controller = sl<SodakoController>();
  SodakoState get state => controller.state;

...
router.push(SendokRoute());
router.replaceAll([SendokRoute()]);
...
@RoutePage()
class SendokView extends StatefulWidget {
  const SendokView({super.key});

  @override
  State<SendokView> createState() => _SendokViewState();
}

class _SendokViewState extends State<SendokView> {
  final controller = sl<SendokController>();
  SendokState get state => controller.state;
